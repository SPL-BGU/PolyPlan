...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 7:
        ...
        if (
            ...
            print(
                "Example: python playground_nsam.py map_type[basic/advanced] map_size[M] solver[FF] use_fluents_map[True/False] fold[0-4] time_out[seconds] optional_max_steps[32*X]"
            )
        else:
